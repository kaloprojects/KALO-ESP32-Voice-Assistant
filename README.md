# Code Samples
Code snippets showing how to record I2S audio and store as .wav file on ESP32 with SD card, how to transcribe audio via Deepgram SpeechToText API, how to generate audio from text via TextToSpeech API from OpenAI a/o Google TTS. This repository contains the Demo sketch 'KALO_ESP32_Voice_Assistant.ino', demonstrating different use case of my 2 libraries 'lib_audio_recording.ino' and 'lib_audio_transcription.ino'.  

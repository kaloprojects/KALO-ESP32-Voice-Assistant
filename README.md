...
- Required (for playing Audio on ESP32, not needed for recording): AUDIO.H library [ESP32-audioI2S.zip](https://github.com/schreibfaul1/ESP32-audioI2S) from Schreibfaul1. Install latest zip  (3.0.11g from June 18, 2024 or newer !)
